		...
		<div className="flex flex-col gap-1">
			...
			<div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-1 pt-6">
				{popularPlants.map((plant, index) => (
					<Card
						key={plant.id}
						className="group max-h-48 flex flex-col rounded-xl border-2 border-slate-300 bg-slate-100 relative overflow-hidden"
					>
						<Image
							src={plant.image}
							className="max-h-20 w-full rounded-t-xl object-cover transition-transform duration-300 group-hover:scale-110"
							width="150"
							height="150"
							alt="ail"
						/>
